    ...
    <div className="rounded-md mt-4 bg-white dark:bg-slate-800 text-black dark:text-white p-24">
      ...
      <div className="flex justify-center items-center mt-20 gap-24">
        <div className="flex flex-col justify-center items-center w-full border p-10 rounded-xl">
          ...
          />
          <p className="mt-6 text-2xl">@techdevshimul</p>
        ...
        <div className="flex flex-col justify-center items-center w-full border p-10 rounded-xl gap-8">
          <h2 className="text-5xl text-center">Contact Via Email</h2>
          <div>
            <label className="text-2xl" htmlFor="full-name">
              Full Name
            </label>
            <input
              className="w-full text-2xl rounded-lg py-1 px-3 mt-3 text-black"
              type="text"
              name="full-name"
              id="full-name"
            />
          ...
          <button className="text-3xl bg-blue-600 w-full py-3 rounded-lg">
            Submit
          </button>
        </div>
      </div>
