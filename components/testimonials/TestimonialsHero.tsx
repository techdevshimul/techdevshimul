  ...
  return (
    <header className="mb-stack-sm text-center md:text-left max-w-3xl">
      ...
      <p className="font-body-lg text-body-lg text-on-surface-variant">
        Discover how technical precision translates into business growth.
        Through modern architectures and high-performance engineering, I help
        visionaries scale their impact.
      </p>
    </header>
  );
}
